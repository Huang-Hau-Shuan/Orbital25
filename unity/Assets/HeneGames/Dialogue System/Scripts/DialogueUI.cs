...
namespace HeneGames.DialogueSystem
{
    public class DialogueUI : MonoBehaviour
    {
        ...
        public void ShowSentence(Sprite _sprite, string _name, string _message)
        {
            StopAllCoroutines();
        ...
        {
            ShowSentence(_dialogueCharacter.characterPhoto, _dialogueCharacter.characterName, _message);
        }
